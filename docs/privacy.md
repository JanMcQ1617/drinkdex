...
This permanently deletes your profile, every post you have made, every
photo you have uploaded, your likes, and your follows in both directions.
It cannot be undone, and your username becomes available to someone else.

Deletion is immediate and complete — photos are removed from storage as
part of the same operation, not left behind. You do not have to email
anyone to be deleted.

## Keeping it

Your data is kept until you delete your account. Reports are kept after
deletion, without the reporter's identity, because a moderation record
that vanishes when the reporter leaves is not a moderation record.
...
interest in keeping the app safe (reports and blocks). You may complain to
